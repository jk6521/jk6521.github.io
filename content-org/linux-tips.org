...
You can download the official arch linux iso from [[https://archlinux.org/download][this website]]. There you can find a lot of options to download, I will show the most popular 2 ways
...
**** Direct ISO file
If you scroll down a bit you can see a list of mirror links followed by country names, click on the nearest available mirror link. You can see the list of packages but you should download the first one which will be like ~archlinux-202x.xx.xx-x86_64.iso~
*** Configuring USB
**** Windows
- Partition your USB in the ~FAT32~ format available in the format options
- Right click on the arch linux iso file and select Mount
